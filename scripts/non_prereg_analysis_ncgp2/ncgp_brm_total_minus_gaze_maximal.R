    ...
    m <- brm(
        bf(
            rt_total_minus_gaze ~ log_freq_z + word_nchar_z + surprisal_nc_z + word_num_in_sent + pos_tag + Region * cond_id +
                (log_freq_z + word_nchar_z + surprisal_nc_z + word_num_in_sent + pos_tag + Region * cond_id || submission_id) +
                (log_freq_z + word_nchar_z + surprisal_nc_z + word_num_in_sent + pos_tag + Region * cond_id || Item),

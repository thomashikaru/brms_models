...
model_name <- "ncgp_total_minus_gaze_maximal"
    ...
    m <- brm(
        bf(
            rt_total_minus_gaze ~ log_freq + word_nchar + surprisal_nc + word_num_in_sent + pos_tag + Region * cond_id +
                (log_freq + word_nchar + surprisal_nc + word_num_in_sent + pos_tag + Region * cond_id || submission_id) +
                (log_freq + word_nchar + surprisal_nc + word_num_in_sent + pos_tag + Region * cond_id || Item),
            hu ~ log_freq + word_nchar + surprisal_nc + word_num_in_sent + pos_tag + Region * cond_id
        ),
        data = dat,

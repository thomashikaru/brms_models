...
# Default values
DEFAULT_TIME="11:59:00"
DEFAULT_MEMORY="16G"
DEFAULT_CPUS="4"
DEFAULT_PARTITION="ou_bcs_normal"
...
# Set number of cores for R/Stan parallelization
# SLURM_CPUS_PER_TASK is automatically set by SLURM based on --cpus-per-task
export MC_CORES=\$SLURM_CPUS_PER_TASK
export OMP_NUM_THREADS=1  # Set to 1 to avoid conflicts with brms parallel chains
export STAN_NUM_THREADS=1  # Set to 1 for brms (each chain uses one core)

# Path to your Singularity image
SINGULARITY_IMAGE="/orcd/data/rplevy/001/om2/thclark/brms_models/brms_240807.sif"
